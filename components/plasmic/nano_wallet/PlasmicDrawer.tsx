...
import Button from "../../Button"; // plasmic-import: 4az4S2sRACi9/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: RdMpYQpDB6L-/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: BFtZ7mt4o3Cj/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: ZYbHPvZEc0PO/icon
...
function PlasmicDrawer__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_1y0m0aLOHvOx"]]: true })}
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__eho3)}
              >
                <div
                  className={classNames(
                    projectcss.all,
